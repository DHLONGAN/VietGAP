...
namespace TNLibrary.SYS.Users
{
    public class Users_Data
    {
        ...
        public static DataTable GetList(string UserName)
        {
        ...
        #endregion
        public static string UpdatePass(string m_UserKey, string m_Password)
        {
            string nResult = ""; ;

            //---------- String SQL Access Database ---------------
            string nSQL = @"UPDATE SYS_USERS SET  Password = @Password,ModifiedBy = @ModifiedBy,ModifiedDateTime = @ModifiedDateTime  WHERE UserKey = @UserKey";
            ...
            try
            {
                ...
                nCommand.Parameters.Add("@ModifiedBy", SqlDbType.NVarChar).Value = m_UserKey;
                nCommand.Parameters.Add("@ModifiedDateTime", SqlDbType.DateTime).Value = DateTime.Now;
