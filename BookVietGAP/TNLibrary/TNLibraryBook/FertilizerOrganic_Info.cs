...
{
    public class FertilizerOrganic_Info
    {
        ...
        public string Create()
        {
            ...
            string zSQL = "INSERT INTO PUL_FertilizerOrganic ("
        ...
        {
            string zSQL = "UPDATE PUL_FertilizerOrganic SET "
                        + " Name = @Name,"
                       ...
                       + " WHERE FertilizerOrganicKey = @FertilizerOrganicKey";
            string zResult = "";
            string zConnectionString = ConnectDataBase.ConnectionString;
            SqlConnection zConnect = new SqlConnection(zConnectionString);
            zConnect.Open();
        ...
        public string Delete()
        {
            string zResult = "";
            //---------- String SQL Access Database ---------------
            string zSQL = "DELETE FROM PUL_FertilizerOrganic WHERE FertilizerOrganicKey = @FertilizerOrganicKey";
            string zConnectionString = ConnectDataBase.ConnectionString;
            SqlConnection zConnect = new SqlConnection(zConnectionString);
            zConnect.Open();
            try
