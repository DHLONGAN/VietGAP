...
namespace TNLibrary.Book
{
    public class Cooperative_Info
    {
        ...
        public Cooperative_Info(int Cooperative_Key)
        {
            ...
            try
            {
                ...
                if (zReader.HasRows)
                {
                    ...
                    _Ward_ID = int.Parse(zReader["Ward_ID"].ToString());
        ...
        + " Cooperative_ID ,Cooperative_Name ,ProvincesCities_ID ,Address ,VietGAPCode ,Phone ,Email ,Members ,Area ,Quantity ,TreeType ,DateRange ,DateExpiration ,Owner ,CertifiedOrganization ,Lat ,Lng ,Images ,Ward_ID ,Description ,CreatedBy ,CreatedDateTime ,ModifiedBy ,ModifiedDateTime ) "
         + " VALUES ( "
         + "@Cooperative_ID ,@Cooperative_Name ,@ProvincesCities_ID ,@Address ,@VietGAPCode ,@Phone ,@Email ,@Members ,@Area ,@Quantity ,@TreeType ,@DateRange ,@DateExpiration ,@Owner ,@CertifiedOrganization ,@Lat ,@Lng ,@Images ,@Ward_ID ,@Description ,@CreatedBy ,@CreatedDateTime ,@ModifiedBy ,@ModifiedDateTime ) ";
            string zResult = "";
            string zConnectionString = ConnectDataBase.ConnectionString;
            ...
            try
            {
                ...
                zCommand.Parameters.Add("@Ward_ID", SqlDbType.Int).Value = _Ward_ID;
