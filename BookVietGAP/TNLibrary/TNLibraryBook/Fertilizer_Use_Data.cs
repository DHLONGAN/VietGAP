...
namespace TNLibrary.Book
{
    public class Fertilizer_Use_Data
    {
        public static DataTable GetList()
        {
            ...
            string zSQL = "SELECT  * FROM PUL_Fertilizer_Use ";
        ...
        {
            DataTable zTable = new DataTable();
            string zSQL = @"SELECT     dbo.PUL_Fertilizer_Use.FertilizerUseKey, dbo.PUL_Fertilizer_Use.FertilizerKey, dbo.PUL_Fertilizers.TradeName, dbo.PUL_Fertilizer_Use.IsActive
                            ...
                            WHERE     (dbo.PUL_Fertilizer_Use.MemberKey = @MemberKey) AND (dbo.PUL_Fertilizer_Use.DateTimeUse = @DateTimeUse)";
            string zConnectionString = ConnectDataBase.ConnectionString;
            try
            {
                SqlConnection zConnect = new SqlConnection(zConnectionString);
