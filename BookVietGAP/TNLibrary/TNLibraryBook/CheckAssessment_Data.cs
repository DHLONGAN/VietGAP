...
namespace TNLibrary.Book
{
    public class CheckAssessment_Data
    {
        public static DataTable GetList()
        {
            ...
            string zSQL = "SELECT  * FROM PUL_CheckAssessment ";
        ...
        {
            DataTable zTable = new DataTable();
            string zSQL = @"SELECT     dbo.PUL_CheckAssessment.CheckAssessmentKey AS KeyID, dbo.PUL_CheckAssessment.DescribesError AS Name, dbo.PUL_CheckAssessment.IsActive
FROM         dbo.PUL_CheckAssessment 
WHERE     (dbo.PUL_CheckAssessment.MemberKey = @MemberKey) AND (dbo.PUL_CheckAssessment.Datetime = @DateTimeUse)";
            string zConnectionString = ConnectDataBase.ConnectionString;
            try
            {
                SqlConnection zConnect = new SqlConnection(zConnectionString);
