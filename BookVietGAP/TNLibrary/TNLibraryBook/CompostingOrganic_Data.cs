...
namespace TNLibrary.Book
{
    public class CompostingOrganic_Data
    {
        public static DataTable GetList()
        {
            ...
            string zSQL = "SELECT  * FROM PUL_CompostingOrganic ";
        ...
        {
            DataTable zTable = new DataTable();
            string zSQL = @"SELECT     dbo.PUL_CompostingOrganic.CompostingKey AS KeyID, dbo.PUL_CompostingOrganic.FertilizerOrganicKey, dbo.PUL_Fertilizers.TradeName AS Name, 
                      dbo.PUL_CompostingOrganic.IsActive
