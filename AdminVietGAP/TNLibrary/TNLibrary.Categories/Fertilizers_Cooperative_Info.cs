...
{
public class Fertilizers_Cooperative_Info
{
...
public Fertilizers_Cooperative_Info()
{
}
public Fertilizers_Cooperative_Info(int ID)
{
string zSQL = "SELECT * FROM PUL_Fertilizers_Cooperative WHERE ID = @ID"; 
...
//---------- String SQL Access Database ---------------
    string zSQL = "INSERT INTO PUL_Fertilizers_Cooperative (" 
+ " CooperativeKey ,FertilizersKey ,CreatedBy ,CreatedDateTime ,ModifiedBy ,ModifiedDateTime ) "
 + " VALUES ( "
 + "@CooperativeKey ,@FertilizersKey ,@CreatedBy ,@CreatedDateTime ,@ModifiedBy ,@ModifiedDateTime ) ";
string zResult = ""; 
string zConnectionString = ConnectDataBase.ConnectionString;
...
{ 
string zSQL = "UPDATE PUL_Fertilizers_Cooperative SET " 
            + " CooperativeKey = @CooperativeKey,"
            + " FertilizersKey = @FertilizersKey,"
            + " CreatedBy = @CreatedBy,"
...
string zResult = "";
//---------- String SQL Access Database ---------------
string zSQL = "DELETE FROM PUL_Fertilizers_Cooperative WHERE ID = @ID";
string zConnectionString = ConnectDataBase.ConnectionString;
SqlConnection zConnect = new SqlConnection(zConnectionString);
zConnect.Open();
try
