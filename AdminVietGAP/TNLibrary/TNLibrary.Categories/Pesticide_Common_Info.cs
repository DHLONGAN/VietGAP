...
{
public class Pesticide_Common_Info
{
...
public Pesticide_Common_Info()
{
}
public Pesticide_Common_Info(int Common_Key)
{
string zSQL = "SELECT * FROM PUL_Pesticide_Common WHERE Common_Key = @Common_Key"; 
...
zCommand.Parameters.Add("@Common_Key", SqlDbType.Int).Value = Common_Key;
SqlDataReader zReader = zCommand.ExecuteReader();
if (zReader.HasRows)
{
zReader.Read();
_Common_Key = int.Parse(zReader["Common_Key"].ToString());
_Common_Name = zReader["Common_Name"].ToString();
...
//---------- String SQL Access Database ---------------
    string zSQL = "INSERT INTO PUL_Pesticide_Common (" 
+ " Common_Name ,CreatedBy ,CreatedDateTime ,ModifiedBy ,ModifiedDateTime ) "
 + " VALUES ( "
 + "@Common_Name ,@CreatedBy ,@CreatedDateTime ,@ModifiedBy ,@ModifiedDateTime ) ";
string zResult = ""; 
string zConnectionString = ConnectDataBase.ConnectionString;
...
zCommand.Parameters.Add("@Common_Name", SqlDbType.NVarChar).Value = _Common_Name;
...
{ 
string zSQL = "UPDATE PUL_Pesticide_Common SET " 
            + " Common_Name = @Common_Name,"
            + " CreatedBy = @CreatedBy,"
            + " CreatedDateTime = @CreatedDateTime,"
            + " ModifiedBy = @ModifiedBy,"
            + " ModifiedDateTime = @ModifiedDateTime"
           + " WHERE Common_Key = @Common_Key";
string zResult = ""; 
string zConnectionString = ConnectDataBase.ConnectionString;
SqlConnection zConnect = new SqlConnection(zConnectionString);
zConnect.Open();
...
string zResult = "";
//---------- String SQL Access Database ---------------
string zSQL = "DELETE FROM PUL_Pesticide_Common WHERE Common_Key = @Common_Key";
string zConnectionString = ConnectDataBase.ConnectionString;
SqlConnection zConnect = new SqlConnection(zConnectionString);
zConnect.Open();
try
