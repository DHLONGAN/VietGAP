...
+ " DatetimeBuy ,PesticideKey ,Quantity ,Price ,CompanyKey ,Address ,MemberKey ,CooperativeKey ,SeedsKey ,UnitKey ,CreatedBy ,CreatedDateTime ,ModifiedBy ,ModifiedDateTime ) "
 + " VALUES ( "
 + "@DatetimeBuy ,@PesticideKey ,@Quantity ,@Price ,@CompanyKey ,@Address ,@MemberKey ,@CooperativeKey ,@SeedsKey ,@UnitKey ,@CreatedBy ,@CreatedDateTime ,@ModifiedBy ,@ModifiedDateTime ) ";
string zResult = ""; 
string zConnectionString = ConnectDataBase.ConnectionString;
