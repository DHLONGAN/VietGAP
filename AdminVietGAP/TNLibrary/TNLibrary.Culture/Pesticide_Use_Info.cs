...
+ " DateTimeUse ,SeedKey ,PestName ,Area ,PesticideKey ,Dose ,Dosage ,EquipmentKey ,MemberKey ,CooperativeKey ,Solution ,QuarantinePeriod ,UnitKey ,CreatedBy ,CreatedDateTime ,ModifiedBy ,ModifiedDateTime ) "
 + " VALUES ( "
 + "@DateTimeUse ,@SeedKey ,@PestName ,@Area ,@PesticideKey ,@Dose ,@Dosage ,@EquipmentKey ,@MemberKey ,@CooperativeKey ,@Solution ,@QuarantinePeriod ,@UnitKey ,@CreatedBy ,@CreatedDateTime ,@ModifiedBy ,@ModifiedDateTime ) ";
string zResult = ""; 
string zConnectionString = ConnectDataBase.ConnectionString;
