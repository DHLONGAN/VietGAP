...
+ " DatetimeBuy ,FertilizerKey ,Quantity ,Price ,CompanyKey ,Address ,MemberKey ,CooperativeKey ,SeedsKey ,UnitKey ,CreatedBy ,CreatedDateTime ,ModifiedBy ,ModifiedDateTime ) "
 + " VALUES ( "
 + "@DatetimeBuy ,@FertilizerKey ,@Quantity ,@Price ,@CompanyKey ,@Address ,@MemberKey ,@CooperativeKey ,@SeedsKey ,@UnitKey ,@CreatedBy ,@CreatedDateTime ,@ModifiedBy ,@ModifiedDateTime ) ";
string zResult = ""; 
string zConnectionString = ConnectDataBase.ConnectionString;
