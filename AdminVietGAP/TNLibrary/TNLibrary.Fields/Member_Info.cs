...
namespace TNLibrary.Fields
{
    public class Member_Info
    {
        ...
        public Member_Info(int Key)
        {
            ...
            try
            {
                ...
                if (zReader.HasRows)
                {
                    ...
                    _MobileCode = zReader["MobileCode"].ToString();
        ...
        + " MemID ,Name ,Cooperative_Key ,Address ,Email ,Phone ,Area ,LatLng ,Description ,MobileCode ,CreatedOn ,ModifiedOn ,CreatedBy ,ModifiedBy ) "
         + " VALUES ( "
         + "@MemID ,@Name ,@Cooperative_Key ,@Address ,@Email ,@Phone ,@Area ,@LatLng ,@Description ,@MobileCode ,@CreatedOn ,@ModifiedOn ,@CreatedBy ,@ModifiedBy ) ";
            string zResult = "";
            string zConnectionString = ConnectDataBase.ConnectionString;
            ...
            try
            {
                ...
                zCommand.Parameters.Add("@MobileCode", SqlDbType.NVarChar).Value = _MobileCode;
                if (_CreatedOn.Year == 0001)
