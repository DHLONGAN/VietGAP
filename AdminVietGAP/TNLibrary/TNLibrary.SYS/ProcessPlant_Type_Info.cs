...
{
public class ProcessPlant_Type_Info
{
 
#region [ Field Name ]
private int _ProcessPlant_TypeKey = 0;
...
public ProcessPlant_Type_Info()
{
}
public ProcessPlant_Type_Info(int ProcessPlant_TypeKey)
{
string zSQL = "SELECT * FROM PUL_ProcessPlant_Type WHERE ProcessPlant_TypeKey = @ProcessPlant_TypeKey"; 
...
zCommand.Parameters.Add("@ProcessPlant_TypeKey", SqlDbType.Int).Value = ProcessPlant_TypeKey;
SqlDataReader zReader = zCommand.ExecuteReader();
if (zReader.HasRows)
{
zReader.Read();
_ProcessPlant_TypeKey = int.Parse(zReader["ProcessPlant_TypeKey"].ToString());
...
#region [ Properties ]
public int ProcessPlant_TypeKey
{
get { return _ProcessPlant_TypeKey; }
set { _ProcessPlant_TypeKey = value; }
}
public string Name
{
get { return _Name; }
...
//---------- String SQL Access Database ---------------
    string zSQL = "INSERT INTO PUL_ProcessPlant_Type (" 
...
SqlCommand zCommand = new SqlCommand(zSQL, zConnect);
zCommand.CommandType = CommandType.Text;
zCommand.Parameters.Add("@ProcessPlant_TypeKey", SqlDbType.Int).Value = _ProcessPlant_TypeKey;
...
{ 
string zSQL = "UPDATE PUL_ProcessPlant_Type SET " 
            + " Name = @Name,"
           ...
           + " WHERE ProcessPlant_TypeKey = @ProcessPlant_TypeKey";
string zResult = ""; 
string zConnectionString = ConnectDataBase.ConnectionString;
SqlConnection zConnect = new SqlConnection(zConnectionString);
zConnect.Open();
...
string zResult = "";
//---------- String SQL Access Database ---------------
string zSQL = "DELETE FROM PUL_ProcessPlant_Type WHERE ProcessPlant_TypeKey = @ProcessPlant_TypeKey";
string zConnectionString = ConnectDataBase.ConnectionString;
SqlConnection zConnect = new SqlConnection(zConnectionString);
zConnect.Open();
try
