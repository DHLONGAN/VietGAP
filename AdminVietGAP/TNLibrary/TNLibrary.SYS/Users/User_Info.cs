    ...
    public class User_Info
    {
        ...
        public User_Info(string UserKey)
        {
            ...
            try
            {
                ...
                {
                    nCommand.Parameters.Add("@UserKey", SqlDbType.UniqueIdentifier).Value = Guid.NewGuid();
                }
                ...
                if (nReader.HasRows)
                {
                    ...
                    _CooperativeVenturesKey = int.Parse(nReader["CooperativeVenturesKey"].ToString());
                }
                nReader.Close();
                nCommand.Dispose();
        ...
        {
            string nSQL = @"SELECT     dbo.SYS_Users.UserKey, dbo.SYS_Users.UserID, dbo.SYS_Users.UserName,dbo.SYS_Users.GroupKey,dbo.SYS_Users.CooperativeKey,dbo.SYS_Users.EmployeeKey, dbo.SYS_Users.Password, dbo.SYS_Users.Description, dbo.SYS_Users.Activate, dbo.SYS_Users.ExpireDate, dbo.Sys_Users.CooperativeVenturesKey ,
...
//                        + " WHERE dbo.SYS_Users.UserName = @UserName ";
            string nSQL = @" SELECT     UserKey, UserID, UserName, Password, Description, Activate, ExpireDate, LastLoginDate, FailedPasswordAttemptCount, CooperativeKey, CooperativeVenturesKey, EmployeeKey, CreatedDateTime, 
                      ModifiedDateTime, GroupKey, CreatedBy, ModifiedBy
                      FROM         dbo.SYS_Users "
                        + " WHERE dbo.SYS_Users.UserName = @UserName ";
        ...
        public string Update()
        {
            ...
            try
            {
                ...
                nCommand.Parameters.Add("@CooperativeVenturesKey", SqlDbType.Int).Value = _CooperativeVenturesKey;
                //if (m_ModifiedBy != "")
                //{
                //    nCommand.Parameters.Add("@ModifiedBy", SqlDbType.UniqueIdentifier).Value = m_ModifiedBy;
                //}
                //else
                //{
                //    nCommand.Parameters.Add("@ModifiedBy", SqlDbType.UniqueIdentifier).Value = null;// new Guid("2930e87b-5b20-465e-9580-aa818b9ea80c");
                //}
        ...
        public string Create()
        {
            ...
            string nSQL = "INSERT INTO SYS_USERS( "
                        + " UserName, Password, Description, Activate,ExpireDate, FailedPasswordAttemptCount,EmployeeKey,CreatedBy,CreatedDateTime,GroupKey,CooperativeKey,CooperativeVenturesKey)"
                        + " VALUES(@UserName, @Password, @Description,@Activate,@ExpireDate,@FailedPasswordAttemptCount,@EmployeeKey,@CreatedBy,getdate(),@GroupKey,@CooperativeKey,@CooperativeVenturesKey)";
