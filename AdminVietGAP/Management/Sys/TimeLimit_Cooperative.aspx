<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimeLimit_Cooperative.aspx.cs" Inherits="Management.Sys.TimeLimit_Cooperative" MasterPageFile="~/SiteMain.Master"%>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:974px; overflow: hidden; Height: 500px;
        position: absolute;">
        <div class="TitleForm">
            <font size=6>GIỚI HẠN THỜI GIAN CHO PHÉP CHỈNH SỬA</font>
        </div>
                    ...
                    <asp:TemplateField HeaderText="Tên hợp tác xã">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("ID")%>')">
                                <asp:Label ID="txtDatetime" Text='<%# Eval("Cooperative_Name")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Số ngày giới hạn">
                        <ItemTemplate>
                            <asp:Label ID="txtSeedsName" Text='<%# Eval("TimeLimit")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("TimeLimit_Cooperative_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
