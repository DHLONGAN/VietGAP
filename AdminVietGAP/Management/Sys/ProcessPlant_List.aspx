<%@ Page Title="" Language="C#" MasterPageFile="~/null.Master" AutoEventWireup="true" CodeBehind="ProcessPlant_List.aspx.cs" Inherits="Management.Sys.ProcessPlant_Edit" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:974px; overflow: hidden; Height: 500px;
        position: absolute;">
        <div class="TitleForm">
            ...
            <asp:GridView ID="GV_List" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tên công việc">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("ProcessPlantDetailKey").ToString() +"|"+ Eval("ProcessPlantDetai_Type").ToString()+ "|" + Eval("ProcessPlantDetai_Type").ToString()%>')">
                                <asp:Label ID="txtDatetime" Text='<%# Eval("Name")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField>
                    <HeaderTemplate>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick='Edit("0|0|0")'/>
                    </HeaderTemplate>
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif" runat="server" OnClientClick="javascript:return confirm('Bạn có chắc chắn xóa không?');"  CommandArgument='<%# Eval("ProcessPlantDetailKey")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("ProcessPlantDetail.aspx?Key=" + ID);
            // oWnd.maximize();
            oWnd.setSize(550, 500);
            oWnd.set_modal(true);
            return false;
        }
