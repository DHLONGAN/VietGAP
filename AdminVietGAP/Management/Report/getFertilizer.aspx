<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="getFertilizer.aspx.cs" Inherits="Management.Report.getFertilizer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="mainOperation">
        <p style="font-size:16pt; font-weight: bold; text-align: center;">THỐNG KÊ SỬ DỤNG PHÂN BÓN THEO TỪNG NĂM</p>
