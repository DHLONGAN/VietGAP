<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="getAreaQuantity.aspx.cs" Inherits="Management.Report.getAreaQuantity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="mainOperation">
        <p style="font-size:16pt; font-weight: bold; text-align: center;">THỐNG KÊ DIỆN TÍCH VÀ SẢN LƯỢNG CÂY TRỒNG THEO TỪNG NĂM</p>
