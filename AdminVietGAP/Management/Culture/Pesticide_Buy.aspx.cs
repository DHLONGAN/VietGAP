...
{
    public partial class Pesticide_Buy : System.Web.UI.Page
    {
            ...
            if (nUserLogin != null)
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                      ...
                      dbo.PUL_Pesticide_Buy ON dbo.PUL_SeedProcess.SeedProcessKey = dbo.PUL_Pesticide_Buy.SeedsKey INNER JOIN
        ...
        protected void cmdView_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            DataTable nTable = Pesticide_Buy_Data.GetList(dtfrom, dtto, Convert.ToInt16(Session["EmployeeKey"]), nPageSize, nPageNumber, DDLSeeds.SelectedValue);
        ...
        protected void LoadPages()
        {
            ...
            int nTotalRecord = Pesticide_Buy_Data.Count(Session["EmployeeKey"].ToInt(), DDLSeeds.SelectedValue);
