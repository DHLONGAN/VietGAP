<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Fertilizer_Use.aspx.cs" Inherits="Management.Culture.Fertilizer_Use" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>SỬ DỤNG PHÂN BÓN</font>
        </div>
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_Fertilizer_Use" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("FertilizerUseKey")%>')">
...
<%--                    <asp:TemplateField HeaderText="Tên cây trồng">
                    ...
                    <asp:TemplateField HeaderText="Phương pháp">
                        <ItemTemplate>
                            <asp:Label ID="txtHowtouse" Text='<%# Eval("Howtouse") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Nguyên vật liệu">
                        <ItemTemplate>
                            <asp:Label ID="txtTradeName" Text='<%# Eval("TradeName")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Liều lượng<br>(Nồng độ)">
                        <ItemTemplate>
                            <asp:Label ID="txtFormulaUsed" Text='<%# Eval("FormulaUsed").ToString() + Eval("UNN").ToString()%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
...
<%--                    <asp:TemplateField HeaderText="Xã viên">
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Fertilizer_Use_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
