<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompostingOrganic_Edit.aspx.cs" Inherits="Management.Culture.CompostingOrganic_Edit" %>
                 ...
                 <tr>
                    <td style="width: 120px; vertical-align:top">
                       Phương pháp ủ
                         ...
                         <td>
                         <asp:Label ID="txtMethod" runat="server"></asp:Label>
                    </td>                  
                </tr>   
                <tr>
                    <td style="width: 120px; vertical-align:top">
                    ...
                    <td>
                       <asp:Label ID="txtCompostingDates" runat="server"
                          ></asp:Label>
                    </td>
