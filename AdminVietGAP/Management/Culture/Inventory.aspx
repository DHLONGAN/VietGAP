<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Inventory.aspx.cs" Inherits="Management.Culture.Inventory" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>KIỂM KÊ TỒN KHO</font>
        </div>
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_CompostingOrganic" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày kiểm kê">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("InventoryKey")%>')">
                                <asp:Label ID="txtDatetime" Text='<%# ConvertDate(Eval("Datetime").ToString())%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Phân bón/hóa chất">
                        <ItemTemplate>
                            <asp:Label ID="txtSeedsName" Text='<%# ConvertName(Eval("Type").ToString(),Eval("FertilizersPesticidesKey").ToString())%>' runat="server"></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Hạn dùng">
                        <ItemTemplate>
                            <asp:Label ID="txtExpireDate" Text='<%# ConvertDate(Eval("ExpireDate").ToString())%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                </Columns>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Inventory_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
