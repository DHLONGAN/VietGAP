<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Fertilizer_Buy.aspx.cs" Inherits="Management.Culture.Fertilizer_Buy" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_Fertilizer_Buy" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày Mua">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("FertilizerBuyKey")%>')">
...
<%--                     <asp:TemplateField HeaderText="Xã viên">
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Fertilizer_Buy_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
            oWnd.setSize(350,300);
            oWnd.set_modal(true);
            return false;
        }
