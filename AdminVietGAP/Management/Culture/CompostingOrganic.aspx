<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="CompostingOrganic.aspx.cs" Inherits="Management.Culture.CompostingOrganic" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>Ủ PHÂN HỮU CƠ</font>
        </div>
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_CompostingOrganic" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày Ủ">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("CompostingKey")%>')">
                                <asp:Label ID="txtDatetime" Text='<%# ConvertDate(Eval("StartDate").ToString())%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Loại phân">
                        <ItemTemplate>
                            <asp:Label ID="txtSeedsName" Text='<%# Eval("TenPhan")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Khối lượng">
                        <ItemTemplate>
                            <asp:Label ID="txtTradeName" Text='<%# Eval("Quantity").ToString() + Eval("Name").ToString() %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Phương pháp ủ">
                        <ItemTemplate>
                            <asp:Label ID="txtCommonName" Text='<%# Eval("Method")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Thời gian ủ">
                        <ItemTemplate>
                            <asp:Label ID="txtCompanyName" Text='<%# Eval("CompostingDates").ToString()  +" Ngày"%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
...
<%--                     <asp:TemplateField HeaderText="Xã viên">
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("CompostingOrganic_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
