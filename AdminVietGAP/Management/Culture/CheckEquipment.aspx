<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="CheckEquipment.aspx.cs" Inherits="Management.Culture.CheckEquipment" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>KIỂM TRA, BẢO TRÌ, VỆ SINH THIẾT BỊ - DỤNG CỤ</font>
        </div>
        ...
        <div>
            <asp:GridView ID="GV_CheckEquipment" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày thực hiện">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("CheckEquipmentKey")%>')">
...
<%--                    <asp:TemplateField HeaderText="Loại cây">
                     ...
                     <asp:TemplateField HeaderText="Thiết bị, dụng cụ">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Hoạt động">
                        <ItemTemplate>
                            <asp:Label ID="txtAction" Text='<%# Eval("Action")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Mô tả phương pháp thực hiện">
                        <ItemTemplate>
                            <asp:Label ID="txtInfo" Text='<%# Eval("Info") %>' runat="server"></asp:Label>
                        </ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("CheckEquipment_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
