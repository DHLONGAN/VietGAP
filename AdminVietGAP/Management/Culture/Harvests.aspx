<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Harvests.aspx.cs" Inherits="Management.Culture.Harvests" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>TIẾP NHẬN NHẬP KHO</font>
        </div>
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_Harvests" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày nhập">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("HarvestsKey")%>')">
                                <asp:Label ID="txtDatetime" Text='<%# ConvertDate(Eval("DateOn").ToString())%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Slượng trước sơ chế">
                        <ItemTemplate>
                            <asp:Label ID="txtWeightBefor" Text='<%# Eval("WeightBefor")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Sọt/rổ trước sơ chế">
                        <ItemTemplate>
                            <asp:Label ID="txtSlotBefor" Text='<%# Eval("SlotBefor") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Center"/>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Slượng sau sơ chế">
                        <ItemTemplate>
                            <asp:Label ID="txtWeightAfter" Text='<%# Eval("WeightBefor")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Sọt/rổ trước sơ chế">
                        <ItemTemplate>
                            <asp:Label ID="txtSlotAfter" Text='<%# Eval("SlotBefor") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Center"/>
                    </asp:TemplateField>
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick="Edit(0)"/>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif " runat="server" OnClientClick="javascript:return confirm('Bạn có chắc chắn xóa không?');"  CommandArgument='<%# Eval("HarvestsKey")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Harvests_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
