<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Training.aspx.cs" Inherits="Management.Culture.Training" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>DANH SÁCH CÔNG NHÂN VÀ ĐÀO TẠO TẬP HUẤN</font>
        </div>
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_Training" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày nhập">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("TrainingKey")%>')">
                    ...
                    <asp:TemplateField HeaderText="Thông tin liên lạc">
                        <ItemTemplate>
                            <asp:Label ID="txtPhone" Text='<%# Eval("Phone")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Công việc">
                        <ItemTemplate>
                            <asp:Label ID="txtJob" Text='<%# Eval("Job") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Center"/>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Nội dung tập huấn">
                        <ItemTemplate>
                            <asp:Label ID="txtTrainingContent" Text='<%# Eval("TrainingContent")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Thời gian tập huấn">
                        <ItemTemplate>
                            <asp:Label ID="txtTrainingTime" Text='<%# ConvertDate(Eval("TrainingTime").ToString())%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Người tập huấn">
                        <ItemTemplate>
                            <asp:Label ID="txtTrainer" Text='<%# Eval("Trainer") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Center"/>
                    </asp:TemplateField>
                    <asp:TemplateField>
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick="Edit(0)"/>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif " runat="server" OnClientClick="javascript:return confirm('Bạn có chắc chắn xóa không?');"  CommandArgument='<%# Eval("TrainingKey")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Training_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
