<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="CheckAssessment.aspx.cs" Inherits="Management.Culture.CheckAssessment" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>KIỂM TRA ĐÁNH GIÁ</font>
        </div>
        <div style="background-color: #e8f3f9; height: 35px; padding: 2px 0 5px 5px">
            <table border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td>
                        Loại cây: <asp:DropDownList ID="DDLSeeds" runat="server">
                        </asp:DropDownList>
                    </td>
                    <td>
        ...
        <div>
            <asp:GridView ID="GV_CheckAssessment" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày kiểm tra">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("CheckAssessmentKey")%>')">
                    ...
                    <asp:TemplateField HeaderText="Mô tả lỗi">
                        <ItemTemplate>
                            <asp:Label ID="txtDescribesError" Text='<%# Eval("DescribesError")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="300px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Phương pháp xử lý">
                        <ItemTemplate>
                            <asp:Label ID="txtMethod" Text='<%# Eval("Method")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="300px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <%--<asp:TemplateField>
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick="Edit(0)"/>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif " runat="server" OnClientClick="javascript:return confirm('Bạn có chắc chắn xóa không?');"  CommandArgument='<%# Eval("PostharvestHandling_Key")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("PostharvestHandling_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
            oWnd.setSize(600, 320);
            oWnd.set_modal(true);
            return false;
        }
