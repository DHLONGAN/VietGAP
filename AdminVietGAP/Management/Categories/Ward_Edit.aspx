<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ward_Edit.aspx.cs" Inherits="Management.Categories.Ward_Edit" %>
        ...
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtWardID" runat="server" Width="495px" 
                            ></asp:TextBox>
                    </td>
