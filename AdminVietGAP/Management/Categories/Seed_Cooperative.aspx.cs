...
{
    public partial class Seed_Cooperative : System.Web.UI.Page
    {
        ...
        protected void LoadPages()
        {
            ...
            int nTotalRecord = Seed_Cooperative_Data.Count(txtSearch.Text, int.Parse(Session["CooperativeKey"].ToString()));
