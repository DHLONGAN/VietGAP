...
{
    public partial class Seeds_Categories : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable nTable = Seeds_Categories_Data.GetList(nPageSize, nPageNumber, txtSearch.Text);
        ...
        protected void cmdView_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            int nPageSize = int.Parse(txtPageSize.Text);
            DataTable nTable = Seeds_Categories_Data.GetList(nPageSize, 1, txtSearch.Text);
            GV_Seeds.DataSource = nTable;
            GV_Seeds.DataBind();
            LoadPages();
        }
        ...
        protected void LoadPages()
        {
            ...
            int nTotalRecord = Seeds_Categories_Data.Count(txtSearch.Text);
