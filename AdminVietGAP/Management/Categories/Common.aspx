<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Common.aspx.cs" Inherits="Management.Categories.Common" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ListLayer" style="border: 0px solid red; width: 100%; overflow: hidden;
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_Common" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Cây trồng">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="SeedsEdit('<%# Eval("Common_Key").ToString()+ "-" +Eval("Loai").ToString()%>')">
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif "
                                ...
                                CommandArgument='<%# Eval("Common_Key")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
    ...
    <script type="text/javascript">
        ...
        function SeedsEdit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Common_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
            oWnd.setSize(740, 380);
            oWnd.set_modal(true);
            return false;
        }
