<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Ward.aspx.cs" Inherits="Management.Categories.Ward" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        ...
        <div style="background-color: #e8f3f9; height: 35px; padding: 2px 0 5px 5px">
            <table border="0" cellpadding="2" cellspacing="0">
                <tr>
                    <td>
                     ...
                     <td>
                        Tỉnh: 
                         <asp:DropDownList ID="DDLProvincesCities" runat="server" AutoPostBack="True" 
                             onselectedindexchanged="DDLProvincesCities_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                     <td>
                        Huyện: <asp:DropDownList ID="DDLDistrict" runat="server">
                        </asp:DropDownList>
                    </td>
                    <td>
         ...
         <div style="padding-right: 20px">
            <asp:GridView ID="GV_Ward" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Mã xã">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="EquipmentEdit('<%# Eval("ID")%>')">
                                <asp:Label ID="txtSeedsName" Text='<%# Eval("WardID")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Tên xã">
                        <ItemTemplate>
                            <asp:Label ID="txtCompanyName" Text='<%# Eval("Name")%>' runat="server"></asp:Label>
                        </ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function EquipmentEdit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Ward_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
