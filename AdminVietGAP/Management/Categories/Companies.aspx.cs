...
namespace Management.Categories
{
    public partial class Companies : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable nTable = Companies_Data.GetList(nPageSize, nPageNumber, txtSearch.Text);
        ...
        protected void GrDelete(object sender, CommandEventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    Companie_Info info = new Companie_Info(mKey);
                    info.Delete();
                    DataTable nTable = Companies_Data.GetList(nPageSize, nPageNumber, txtSearch.Text);
                    GV_Companie.DataSource = nTable;
                    GV_Companie.DataBind();
        ...
        protected void LoadPages()
        {
            ...
            int nTotalRecord = Companies_Data.Count(txtSearch.Text);
