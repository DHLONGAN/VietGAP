<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true"
    CodeBehind="Seeds.aspx.cs" Inherits="Management.Categories.Seeds" %>
...
<%--                    <asp:TemplateField HeaderText="Cây trồng">
                    ...
                    <asp:TemplateField HeaderText="Tên giống">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="SeedsEdit('<%# Eval("SeedsKey")%>')">
                                <asp:Label ID="txtSeedsName" Text='<%# Eval("SeedsName")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Cơ quan tác giả">
                        <ItemTemplate>
                            <asp:Label ID="txtCompanyName" Text='<%# Eval("CompanyName")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Mức độ công nhận">
                        <ItemTemplate>
                            <asp:Label ID="txtStatusName" Text='<%# Eval("StatusName")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="120px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Vụ/Vùng công nhận">
                        <ItemTemplate>
                            <asp:Label ID="txtSeasonName" Text='<%# Eval("SeasonName")%>' runat="server"></asp:Label>
                        </ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function SeedsEdit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Seeds_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
