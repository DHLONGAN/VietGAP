...
{
    public partial class ProvincesCities : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable nTable = ProvincesCities_Data.GetList(nPageSize, nPageNumber, txtSearch.Text);
        ...
        protected void cmdView_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            int nPageNumber = int.Parse(txtPageNumber.Text);
            int nPageSize = int.Parse(txtPageSize.Text);
            DataTable nTable = ProvincesCities_Data.GetList(nPageSize, 1, txtSearch.Text);
            GV_Equipment.DataSource = nTable;
            GV_Equipment.DataBind();
            LoadPages();
        }
        ...
        protected void LoadPages()
        {
            ...
            int nTotalRecord = ProvincesCities_Data.Count(txtSearch.Text);
