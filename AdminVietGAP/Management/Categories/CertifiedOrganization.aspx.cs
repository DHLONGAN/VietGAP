...
{
    public partial class CertifiedOrganization : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable nTable = CertifiedOrganization_Data.GetList(nPageSize, nPageNumber, txtSearch.Text);
            GV_CertifiedOrganization.DataSource = nTable;
            GV_CertifiedOrganization.DataBind();
            LoadPages();
        }
        ...
        protected void GrDelete(object sender, CommandEventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    CertifiedOrganization_Info info = new CertifiedOrganization_Info(mKey);
                    info.Delete();
                    DataTable nTable = CertifiedOrganization_Data.GetList(nPageSize, nPageNumber, txtSearch.Text);
                    GV_CertifiedOrganization.DataSource = nTable;
                    GV_CertifiedOrganization.DataBind();
        ...
        protected void LoadPages()
        {
            ...
            int nTotalRecord = CertifiedOrganization_Data.Count(txtSearch.Text);
