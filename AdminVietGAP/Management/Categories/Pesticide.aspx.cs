...
namespace Management.Categories
{
    public partial class Pesticide : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable nTable = Pesticides_Data.GetList(nPageSize, nPageNumber, "");
        ...
        protected void cmdView_Click(object sender, ImageClickEventArgs e)
        {
            ...
            int nPageSize = int.Parse(txtPageSize.Text);
            int nPageNumber = int.Parse(txtPageNumber.Text);
            DataTable nTable = Pesticides_Data.GetList(nPageSize, nPageNumber, txtSearch.Text);
            GV_Pesticides.DataSource = nTable;
            GV_Pesticides.DataBind();
            LoadPages();
        }
        ...
        protected void LoadPages()
        {
            ...
            int nTotalRecord = Pesticides_Data.Count(txtSearch.Text);
