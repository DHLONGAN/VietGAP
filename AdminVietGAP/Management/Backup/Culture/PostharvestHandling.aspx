<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="PostharvestHandling.aspx.cs" Inherits="Management.Culture.PostharvestHandling" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>XỬ LÝ SAU THU HOẠCH</font>
        </div>
        ...
        <div>
            <asp:GridView ID="GV_PostharvestHandling" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày thực hiện">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("PostharvestHandling_Key")%>')">
                    ...
                    <asp:TemplateField HeaderText="Loại cây">
                     ...
                     <asp:TemplateField HeaderText="Phương pháp xử lý">
                        <ItemTemplate>
                            <asp:Label ID="txtEquipmentName" Text='<%# Eval("Method")%>' runat="server"></asp:Label>
                        </ItemTemplate>
