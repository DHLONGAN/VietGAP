<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessEnvironmental_Edit.aspx.cs" Inherits="Management.Culture.ProcessEnvironmental_Edit" %>
        ...
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td>
                       <asp:TextBox ID="txtSolution" runat="server" Width="257px" Height="20px"></asp:TextBox>
                    </td>
