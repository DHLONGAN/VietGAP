<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSale.aspx.cs" Inherits="Management.Culture.AddSale" %>
        ...
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtSeedName" runat="server" Width="245px" Enabled="False"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtcode" runat="server"  Width="245px" Enabled="False"></asp:TextBox>
                    </td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtSolution" runat="server"  Width="245px">Rửa sạch, phơi khô, đóng gói</asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtMember" runat="server"  Width="245px" Enabled="false"></asp:TextBox>
                    </td>
