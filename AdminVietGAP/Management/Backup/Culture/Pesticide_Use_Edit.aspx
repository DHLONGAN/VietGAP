<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pesticide_Use_Edit.aspx.cs" Inherits="Management.Culture.Pesticide_Use_Edit" %>
...
<body>
    ...
    <div>
        <div class="HeaderFormSub">
            THÔNG TIN SỬ DỤNG THUỐC BVTV</div>
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    <td style="width: 120px; vertical-align:top">
                       Lý do áp dụng/ Mật độ
                         ...
                         <td>
                         <asp:Label ID="txtPestName" runat="server"></asp:Label>
                    </td>                  
                </tr> 
                <tr>
                    <td style="width: 120px; vertical-align:top">
                ...
                <tr>
                    ...
                    <td>
                         <asp:Label ID="DDLPesticide" runat="server" >
                        </asp:Label>
                    </td>
...
<%--                <tr>
                    ...
                    <td>
                         <asp:Label ID="DDLSeed" runat="server" Width="250px">
                        </asp:Label>
                    </td>
                ...
                <tr>
                    <td style="width: 120px; vertical-align:top">
                     Liều lượng
                         ...
                         <td>
                         <asp:Label ID="txtDose" runat="server"></asp:Label>&nbsp;<asp:Label 
                 ...
                 <tr>
                    <td style="width: 120px; vertical-align:top">
                       Tổng lượng/ Lít nước
                         ...
                         <td>
                         <asp:Label ID="txtDosage" runat="server"></asp:Label>
                    </td>                  
                </tr>   
                <tr>
                    <td style="width: 120px; vertical-align:top">
