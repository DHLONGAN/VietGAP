<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="HandlingPackaging.aspx.cs" Inherits="Management.Culture.HandlingPackaging" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
       ...
       <div style="padding-right: 20px">
            <asp:GridView ID="GV_HandlingPackaging" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày nhập">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("HandlingPackagingKey")%>')">
                                <asp:Label ID="txtDatetime" Text='<%# ConvertDate(Eval("Datetime").ToString())%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Loại bao bì/ thùng chứa/thuốc dư thừa">
                        <ItemTemplate>
                            <asp:Label ID="txtType" Text='<%# Eval("Type")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="300px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Nơi lưu trữ">
                        <ItemTemplate>
                            <asp:Label ID="txtPlace" Text='<%# Eval("Place") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="100px" HorizontalAlign="Center"/>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Cách xử lý">
                        <ItemTemplate>
                            <asp:Label ID="txtTreatment" Text='<%# Eval("Treatment")%>' runat="server"></asp:Label>
                        </ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("HandlingPackaging_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
