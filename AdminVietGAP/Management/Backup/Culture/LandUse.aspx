<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="LandUse.aspx.cs" Inherits="Management.Culture.PUL_LandUse" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        ...
        <div>
            <asp:GridView ID="GV_LandUse" runat="server" Width="100%" AutoGenerateColumns="false"
...
<%--                    <asp:TemplateField HeaderText="Giống">
                    ...
                    <asp:TemplateField HeaderText="Lý do áp dụng/ Mật độ">
                        <ItemTemplate>
                            <asp:Label ID="txtReason" Text='<%# Eval("Reason")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Ghi chú">
                        <ItemTemplate>
                            <asp:Label ID="txtNote" Text='<%# Eval("Note") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="250px" HorizontalAlign="Center"/>
                    </asp:TemplateField>
                </Columns>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("LandUse_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
