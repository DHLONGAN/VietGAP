<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostharvestHandling_Edit.aspx.cs" Inherits="Management.Culture.PostharvestHandling_Edit" %>
...
<body>
    ...
    <div style="padding: 10px">
        <div class="HeaderFormSub">
            THÔNG TIN XỬ LÝ SAU THU HOẠCH</div>
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtMethod" runat="server" Width="220px"></asp:TextBox>
                    </td>
