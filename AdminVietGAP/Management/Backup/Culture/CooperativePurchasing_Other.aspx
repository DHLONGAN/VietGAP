<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="CooperativePurchasing_Other.aspx.cs" Inherits="Management.Culture.CooperativePurchasing_Other" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        ...
        <div class="TitleForm">
            <font size=6>Danh sách thu mua rau an toàn</font>
        </div>  
        <div>
            <asp:GridView ID="GV_HarvestedForSale" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit_('<%# Eval("Purchasing_OtherKey")%>')">
                    ...
                    <asp:TemplateField HeaderText="Số lượng sọt/rổ">
                        <ItemTemplate>
                   ...
                   <asp:TemplateField>
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick="Edit(0)"/>
                        ...
                        <ItemTemplate>
                         <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif" runat="server" OnClientClick="javascript:return confirm('Bạn có chắc chắn xóa không?');"  CommandArgument='<%# Eval("Purchasing_OtherKey")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("CooperativePurchasing_Other_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
