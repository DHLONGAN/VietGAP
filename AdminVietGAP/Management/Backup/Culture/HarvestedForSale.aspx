<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="HarvestedForSale.aspx.cs" Inherits="Management.Culture.HarvestedForSale" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>QUẢN LÝ THU HOẠCH - XUẤT BÁN</font>
        </div>
