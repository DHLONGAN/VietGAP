<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inventory_Edit.aspx.cs" Inherits="Management.Culture.Inventory_Edit" %>
        ...
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                       <asp:Label ID="txtExpireDate" runat="server"
                          ></asp:Label>
                    </td>
