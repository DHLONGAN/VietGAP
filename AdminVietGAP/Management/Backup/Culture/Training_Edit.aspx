<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Training_Edit.aspx.cs" Inherits="Management.Culture.Training_Edit" %>
    ...
    <script src="/Lib/calendar/jquery-ui.js"></script>
     ...
     <script type="text/javascript">
         $(function () {
             ...
             $("#txtTrainingTime").datepicker();
             //$("#txtDatetime").datepicker("option", "dateFormat", "dd-mm-yy");
              var availableTags = [<% = Job %>];
              var availableTags2 = [<% = TrainingContent %>];
              var availableTags3 = [<% = Trainer %>];
$( "#txtJob" ).autocomplete({
source: availableTags
});
$( "#txtTraningContent" ).autocomplete({
        ...
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                 ...
                 <tr>
                    <td style="width: 120px; vertical-align:top">
                       Công việc
                         ...
                         <td>
                         <asp:TextBox ID="txtJob" runat="server" Width="255px"></asp:TextBox>
                    </td>                  
                </tr>   
                  <tr>
                    <td style="width: 120px; vertical-align:top">
                       Nội dung tập huấn
                         ...
                         <td>
                         <asp:TextBox ID="txtTrainingContent" runat="server" Width="255px"></asp:TextBox>
                    </td>                  
                </tr>   
                <tr>
                    <td style="width: 120px; vertical-align:top">
                    ...
                    <td>
                         ...
                         <asp:TextBox ID="txtTrainingTime" runat="server" Width="255px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                       <asp:TextBox ID="txtTrainer" runat="server" Width="257px"></asp:TextBox>
                    </td>
