...
{
    public partial class CooperativeSale : System.Web.UI.Page
    {
        ...
        protected void cmdView_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            DataTable nTable = CooperativeSale_Data.GetList(dtfrom, dtto, nPageSize, nPageNumber, Session["CooperativeKey"].ToInt());
