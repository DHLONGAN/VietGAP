...
{
    public partial class PostharvestHandling : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (nUserLogin != null)
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        LoadDataToToolboxWeb.DropDown_DDL(DDLSeeds, "Select SeedsKey,SeedsName from PUL_Seeds where SeedsKey IN (Select SeedsKey FROM PUL_PostharvestHandling WHERE MemberKey = " + Convert.ToInt16(Session["EmployeeKey"]) + ")", false);
                        LoadData();
        ...
        protected void cmdView_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            DataTable nTable = PostharvestHandling_Data.GetList(dtfrom, dtto, Convert.ToInt16(Session["EmployeeKey"]), nPageSize, nPageNumber, DDLSeeds.SelectedValue.ToInt());
        ...
        //    GV_PostharvestHandling.PageIndex = e.NewPageIndex;
        //    DataTable nTable = PostharvestHandling_Data.GetList();
        //    GV_PostharvestHandling.DataSource = nTable;
        //    GV_PostharvestHandling.DataBind();
        ...
        protected void LoadPages()
        {
            ...
            int nTotalRecord = PostharvestHandling_Data.Count(Session["EmployeeKey"].ToInt(), DDLSeeds.SelectedValue.ToInt());
