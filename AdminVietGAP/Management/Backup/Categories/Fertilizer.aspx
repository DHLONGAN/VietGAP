<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fertilizer.aspx.cs" Inherits="Management.Categories.Fertilizer"  MasterPageFile="~/SiteMain.Master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_Fertilizers" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tên thương phẩm">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="FertilizerEdit('<%# Eval("FertilizersKey")%>')">
                                <asp:Label ID="txtTrade_Name" Text='<%# Eval("TradeName")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Đơn vị">
                        <ItemTemplate>
                            <asp:Label ID="txtCrop_Name" Text='<%# Eval("Fertilizer_Unit_Name")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick="FertilizerEdit(0)"/>
                    </HeaderTemplate>
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif " runat="server" OnClientClick="javascript:return confirm('Bạn có chắc chắn xóa không?');"  CommandArgument='<%# Eval("FertilizersKey")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function FertilizerEdit(ID) {
            var oWnd = $find("<%= rwPesticide.ClientID %>");
            oWnd.show();
            oWnd.setUrl("Fertilizer_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
            oWnd.setSize(700, 470);
            oWnd.set_modal(true);
            return false;
        }
