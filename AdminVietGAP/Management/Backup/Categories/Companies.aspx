<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Companies.aspx.cs" Inherits="Management.Categories.Companies" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>CÔNG TY SẢN XUẤT - PHÂN PHỐI</font>
        </div>
            ...
            <asp:GridView ID="GV_Companie" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tên Công ty">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="CompanieEdit('<%# Eval("CompanyKey")%>')">
                    ...
                    <asp:TemplateField>
                    <HeaderTemplate>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick="CompanieEdit(0)"/>
                    </HeaderTemplate>
                        <ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function CompanieEdit(ID) {
            var oWnd = $find("<%= rwPesticide.ClientID %>");
            oWnd.show();
            oWnd.setUrl("Companie_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
