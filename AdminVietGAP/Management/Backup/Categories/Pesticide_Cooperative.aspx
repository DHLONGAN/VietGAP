<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Pesticide_Cooperative.aspx.cs" Inherits="Management.Categories.PUL_Pesticide_Cooperative" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>DANH SÁCH THUỐC BVTV CỦA HTX</font>
        </div>
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_Pesticide_Cooperative" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tên thuốc BVTV">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("ID")%>')">
                                <asp:Label ID="txtSeedsName" Text='<%# Eval("Trade_Name")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Pesticide_Cooperative_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
