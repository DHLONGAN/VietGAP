<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Equipment.aspx.cs" Inherits="Management.Categories.Equipment" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <asp:GridView ID="GV_Equipment" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tên thiết bị">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="EquipmentEdit('<%# Eval("EquipmentKey")%>')">
                                <asp:Label ID="txtSeedsName" Text='<%# Eval("EquipmentName")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick="EquipmentEdit(0)"/>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif " runat="server" OnClientClick="javascript:return confirm('Bạn có chắc chắn xóa không?');"  CommandArgument='<%# Eval("EquipmentKey")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function EquipmentEdit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Equipment_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
