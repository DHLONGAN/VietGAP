<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="ProvincesCities.aspx.cs" Inherits="Management.Categories.ProvincesCities" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        ...
        <div style="background-color: #e8f3f9; height: 35px; padding: 2px 0 5px 5px">
         ...
         <div style="padding-right: 20px">
            <asp:GridView ID="GV_Equipment" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Mã tỉnh">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="EquipmentEdit('<%# Eval("ProvincesCities_Key")%>')">
                                <asp:Label ID="txtSeedsName" Text='<%# Eval("ProvincesCities_ID")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Tên tỉnh">
                        <ItemTemplate>
                            <asp:Label ID="txtCompanyName" Text='<%# Eval("ProvincesCities_Name")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~\Img\Icons\add_one.png" style="cursor: pointer" onClick="EquipmentEdit(0)"/>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdDel" CommandName="ItemDel" OnCommand="GrDelete" ImageUrl="~\Img\Icons\Del.gif " runat="server" OnClientClick="javascript:return confirm('Bạn có chắc chắn xóa không?');"  CommandArgument='<%# Eval("ProvincesCities_Key")%>' />
                        </ItemTemplate>
                        <ItemStyle Width="20px" HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function EquipmentEdit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("ProvincesCities_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
