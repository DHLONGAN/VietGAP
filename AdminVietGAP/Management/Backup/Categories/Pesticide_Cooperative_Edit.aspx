<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pesticide_Cooperative_Edit.aspx.cs" Inherits="Management.Categories.Pesticide_Cooperative_Edit" %>
...
<body>
    ...
    <div style="padding: 10px">
        <div class="HeaderFormSub">
            THÔNG TIN THUỐC BVTV CỦA HTX</div>
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DDLPesticide" runat="server" Width="255px">
                        </asp:DropDownList>
                    </td>
                </tr>            
            </table>           
