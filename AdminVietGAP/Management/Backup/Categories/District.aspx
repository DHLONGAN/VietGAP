<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="District.aspx.cs" Inherits="Management.Categories.District" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div style="background-color: #e8f3f9; height: 35px; padding: 2px 0 5px 5px">
            <table border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td>
                        Tỉnh: <asp:DropDownList ID="DDLProvincesCities" runat="server">
                        </asp:DropDownList>
                    </td>
                    <td>
         ...
         <div style="padding-right: 20px">
            <asp:GridView ID="GV_District" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Mã huyện">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="EquipmentEdit('<%# Eval("ID")%>')">
                                <asp:Label ID="txtDisID" Text='<%# Eval("DisID")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Tên huyện">
                     ...
                     <asp:TemplateField HeaderText="Ghi chú">
                        <ItemTemplate>
                            <asp:Label ID="Description" Text='<%# Eval("Name")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function EquipmentEdit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("District_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
