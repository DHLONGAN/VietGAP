<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="Fertilizers_Cooperative.aspx.cs" Inherits="Management.Categories.Fertilizers_Cooperative" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div id="ListLayer" style="border: 0px solid red; width:100%; overflow: hidden; 
        position: absolute;">
        <div class="TitleForm">
            <font size=6>DANH SÁCH PHÂN BÓN CỦA HTX</font>
        </div>
        ...
        <div style="padding-right: 20px">
            <asp:GridView ID="GV_Fertilizers_Cooperative" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tên Phân bón">
                        <ItemTemplate>
                            <div style="cursor: pointer" onclick="Edit('<%# Eval("ID")%>')">
                                <asp:Label ID="txtSeedsName" Text='<%# Eval("TradeName")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
     ...
     <telerik:RadWindow ID="rwFertilizers" runat="server" Skin="Vista" Behavior="Close"
        Left="0" Top="0">
    </telerik:RadWindow>
    <script type="text/javascript">
        ...
        function Edit(ID) {
            var oWnd = $find("<%= rwFertilizers.ClientID %>");
            oWnd.show();
            oWnd.setUrl("Fertilizers_Cooperative_Edit.aspx?Key=" + ID);
            // oWnd.maximize();
