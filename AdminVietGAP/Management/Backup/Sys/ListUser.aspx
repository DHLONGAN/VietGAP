<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true" CodeBehind="ListUser.aspx.cs" Inherits="Management.Sys.ListUser" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <asp:GridView ID="GV_Users_Roles" runat="server" runat="server" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tài khoản">
                        <ItemTemplate>                           
                                <div style="cursor: pointer" onclick="Users_RolesEdit('<%# Eval("UserKey")%>')">
                                <asp:Label ID="txtUserName" Text='<%# Eval("UserName")%>' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Loại tài khoản">
                        <ItemTemplate>                           
                                <asp:Label ID="txtUserName" Text='<%# Rank(Eval("GroupKey").ToString())%> ' runat="server"></asp:Label>
                            </div>
                        </ItemTemplate>
                        <ItemStyle Width="150px" HorizontalAlign="Left" />
                    </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function Users_RolesEdit(ID) {
            ...
            oWnd.show();
            oWnd.setUrl("Users_Roles.aspx?Key=" + ID);
            // oWnd.maximize();
