<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Role_Edit.aspx.cs" Inherits="Management.Sys.Role_Edit" %>
        ...
        <div style="float:left">
            <table border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td>
                         <asp:DropDownList ID="DDLWeb_Menu" runat="server" Width="263px" 
                ...
                <tr>
                    ...
                    <td>
                         <asp:TextBox ID="txtRoleID" runat="server" Width="255px"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                         <asp:TextBox ID="txtRoleName" runat="server" Width="255px"></asp:TextBox>
                    </td>
