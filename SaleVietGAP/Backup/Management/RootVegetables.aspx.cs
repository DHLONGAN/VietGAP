...
{
    public partial class RootVegetables : System.Web.UI.Page
    {
        ...
        protected string LoadDSHTX(string id)
        {
            ...
            for (int i = 0; i < nTable.Rows.Count; i++)
            {
                ...
                listCooperative += "{Cooperative_Key:'" + nTable.Rows[i]["Cooperative_Key"] + "',Cooperative_Name:'" + nTable.Rows[i]["Cooperative_Name"] + "',Lat:" + nTable.Rows[i]["Lat"] + ",Lng:" + nTable.Rows[i]["Lng"] + ",Icon:'" + nTable.Rows[i]["Images"] + "',Phone:'" + nTable.Rows[i]["Phone"] + "',Address:'" + nTable.Rows[i]["Address"] + "'},";
            }
