...
{
    public class Companies_Purchase_Info
    {
        ...
        public Companies_Purchase_Info()
        {
        }
        public Companies_Purchase_Info(int CompanyKey)
        {
            string zSQL = "SELECT * FROM PUL_Companies_Purchase WHERE CompanyKey = @CompanyKey";
        ...
        public string Create()
        {
            ...
            string zSQL = "INSERT INTO PUL_Companies_Purchase ("
        ...
        {
            string zSQL = "UPDATE PUL_Companies_Purchase SET "
        ...
        public string Delete()
        {
            string zResult = "";
            //---------- String SQL Access Database ---------------
            string zSQL = "DELETE FROM PUL_Companies_Purchase WHERE CompanyKey = @CompanyKey";
            string zConnectionString = ConnectDataBase.ConnectionString;
            SqlConnection zConnect = new SqlConnection(zConnectionString);
            zConnect.Open();
            try
